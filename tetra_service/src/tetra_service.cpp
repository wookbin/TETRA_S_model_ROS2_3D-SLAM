...
public:
	TETRA_SERVICE() : Node("tetra_service")
	{
		...
		//initial_pose_publisher = this->create_publisher<geometry_msgs::msg::PoseWithCovarianceStamped>("initialpose", 10); //AMCL
		initial_pose_publisher = this->create_publisher<geometry_msgs::msg::PoseWithCovarianceStamped>("initialpose",rclcpp::QoS(1).transient_local().reliable()); //rtabmap_localization
	...
	//geometry_msgs::msg::PoseWithCovarianceStamped initPose; //AMCL
	geometry_msgs::msg::PoseWithCovarianceStamped initPose; //rtabamap_localization
	...
	rclcpp::Publisher<geometry_msgs::msg::PoseWithCovarianceStamped>::SharedPtr rtabmap_initialpose_publisher;
		...
		const std::shared_ptr<interfaces::srv::RunNavigation::Response> response)
	{
		...
		//string str_command2 = str_command + request->map_name.c_str() + ".yaml"; //2D Navigation
		string str_command2 = str_command + request->map_name.c_str(); //3D Navigation
